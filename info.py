...
OWNER_ID = environ.get('OWNER_ID', '6312622799')
...
CODE = (environ.get('CODE', 'https://graph.org/file/02e7ecc3e269b481b914.jpg'))
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '6312622799').split()]
...
# MongoDB information
DATABASE_URI = 'mongodb+srv://<db_username>:Bumayong123.@netpg.1akoj50.mongodb.net/?retryWrites=true&w=majority&appName=Netpg'
DATABASE_NAME = 'AutoFilterDB'
...
AI_LOGS = int(environ.get("AI_LOGS", "-1001868871195"))
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'sewxiy')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+DnmZbLjS0iw0YWI1')
